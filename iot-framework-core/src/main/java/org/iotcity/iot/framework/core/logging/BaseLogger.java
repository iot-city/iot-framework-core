...
/**
 * The base logger object, used to provide the common logger support.
 * @author ardon
 * @date 2021-08-10
 */
public abstract class BaseLogger implements Logger {
	 ...
	 */
	protected BaseLogger(String name, boolean colorful, Class<?> clazz, int callerDepth, Map<String, LogLevel> levels) {
	...
	@Override
	public final boolean config(LogLevel[] data, boolean reset) {
	...
	@Override
	public final void log(Object message, Throwable e) {
