...
/**
 * Thread pool executor configure data of default task handler instance.
 * @author ardon
 * @date 2021-08-10
 */
public class TaskThreadPoolConfig {
	...
	/**
	 * The capacity of blocking queue to cache tasks in thread pool executor (1600 by default, when set to 0, the synchronous queue {@link SynchronousQueue } is used; when set to greater than 0, the bounded priority blocking queue {@link PriorityLimitedBlockingQueue } is used; when set to less than 0, the unbounded priority blocking queue {@link PriorityBlockingQueue } is used).
	 */
	public int capacity = 1600;
